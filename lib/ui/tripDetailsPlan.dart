                               ...
                               Padding(
                                 ...
                                 child: TextButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color.fromARGB(255, 2, 94, 14),
                                               ...
                                               itemBuilder: (context, index) {
                                                 ...
                                                 if (index == listTiles.length - 1) {
                                                   ...
                                                   return InkWell(
                                                     ...
                                                     child: Card(
                                                     elevation: 0,
                                                     color:currentIndex==index?const Color.fromARGB(255, 0, 0, 0):const Color.fromARGB(255, 230, 230, 230),
                                                     clipBehavior: Clip.antiAliasWithSaveLayer,
                                                     shape: RoundedRectangleBorder(
                                                             borderRadius: BorderRadius.circular(10.0),
                                                           ),
                                                             ...
                                                             children: [
                                                               Text(
                                                                 ...
                                                                 style: GoogleFonts.cabin(
                                                                           // ignore: prefer_const_constructors
                                                                           textStyle: TextStyle(
                                                                           color: currentIndex==index?const Color.fromARGB(255, 255, 255, 255):const Color.fromARGB(255, 0, 0, 0),
                                                                           fontSize: 14,
                                                                           fontWeight: FontWeight.bold,
