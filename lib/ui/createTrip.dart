...
class createTrip extends StatefulWidget {
  ...
  final isEditTrip;
  final Trip trip;
  const createTrip({super.key, required this.placeName,required this.placePhotoUrl,required this.isEditTrip,required this.trip}) ;
...
class _createNewTripState extends State<createTrip> {
  ...
  Future<String> getBackGroundImage ()async{
    ...
    const image = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400";
