...
class modalBottomSheetButton extends StatefulWidget {
  ...
  const modalBottomSheetButton({super.key, required this.currentIndex,required this.parentContext});

  @override
  State<modalBottomSheetButton> createState() => _modalBottomSheetButtonState(currentIndex,parentContext);
}
